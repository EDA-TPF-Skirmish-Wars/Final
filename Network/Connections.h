...
public:
	...
	char initGame(void * callback(const char* mapName, unsigned int mapNameSize, int checksum, Game * game) = NULL,\
		unsigned int sizeOfMapName = 0, int checksum = 0, const char * mapName = NULL, Game * game = NULL);
	...
	bool sendMessage(move_s move, int data1 = 0, int data2 = 0, int data3 = 0, int data4 = 0, int data5 = 0,\
		bool callback(move_s move, int data1, int data2, int data3, int data4, int data5, Game * game) =NULL, Game * game = NULL);
	...
	int waitForMyTurn(bool callback(move_s move,int data1, int data2 , int data3, int data4, int data5, Game * game),\
	int callbackResponseAttack(Game * game), Game * game = NULL); 
